...
app.controller("KnowIssueCtrl", ['$scope', '$window', '$http', '$log', '$timeout', 'uiGridConstants', function ($scope, $window, $http, $log, $timeout, uiGridConstants) {
    ...
    $http.post("WebServiceMockUp.asmx/GetKnowIssue",
