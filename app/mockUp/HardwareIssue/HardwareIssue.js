...
app.controller("HardwareIssueCtrl", ['$scope', '$window', '$http', '$log', '$timeout', 'uiGridConstants', function ($scope, $window, $http, $log, $timeout, uiGridConstants) {
    ...
    $http.post("WebServiceMockUp.asmx/GetHardwareIssue",
