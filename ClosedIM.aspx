<%@ Page Title="" Language="C#" MasterPageFile="~/WorstCell.master" AutoEventWireup="true" CodeFile="ClosedIM.aspx.cs" Inherits="ClosedIM" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="app/mockUp/ClosedIM/ClosedIM.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentWrapper" runat="Server">
    <div ng-controller="ClosedIMCtrl">
        <div class="row-fluid">
            <div class="span12">
        ...
        <div class="row-fluid">
            ...
            <div class="widget green classHighChart">
                ...
                <div ng-controller="hichartCtrl">
                    <highchart id="chart1" config="chartConfig_ClosedIM"></highchart>
        ...
        <div class="span6 lineChart">
            <div class="widget blue classHighChart">
                ...
                <div ng-controller="hichartCtrl">
                    <highchart id="chart2" config="chartConfig_ProblemCat_Pie"></highchart>
