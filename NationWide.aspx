<%@ Page Title="" Language="C#" MasterPageFile="~/WorstCell.master" AutoEventWireup="true" CodeFile="NationWide.aspx.cs" Inherits="NationWide" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentWrapper" runat="Server">
    <input type="hidden" class="hiddenRegion" name="name" value="<%=this.Region %>" />
